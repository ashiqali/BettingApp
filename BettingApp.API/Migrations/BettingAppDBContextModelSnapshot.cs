...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BettingApp.API.IdentityAuth.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BettingApp.API.Models.Competitor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BettingApp.API.Models.Fixture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BettingApp.API.Models.FixtureDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BettingApp.API.Models.LookupPlayer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BettingApp.API.Models.LookupSport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BettingApp.API.Models.LookupStadium", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BettingApp.API.Models.LookupTeam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BettingApp.API.Models.Market", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BettingApp.API.Models.Competitor", b =>
                {
                    b.HasOne("BettingApp.API.Models.FixtureDetail", "FixtureDetails")
                        .WithMany("Competitors")
                        .HasForeignKey("FixtureDetailsId")
                        .HasConstraintName("FK_Competitors_FixtureDetails")
                        .IsRequired();

                    b.HasOne("BettingApp.API.Models.LookupPlayer", "Player")
                        .WithMany("Competitors")
            ...
            modelBuilder.Entity("BettingApp.API.Models.Fixture", b =>
                {
                    b.HasOne("BettingApp.API.Models.Market", "Winner")
                        .WithMany("Fixtures")
            ...
            modelBuilder.Entity("BettingApp.API.Models.FixtureDetail", b =>
                {
                    b.HasOne("BettingApp.API.Models.Fixture", "Fixture")
                        .WithMany("FixtureDetails")
                        .HasForeignKey("FixtureId")
                        .HasConstraintName("FK_FixtureDetails_Fixture")
                        .IsRequired();

                    b.HasOne("BettingApp.API.Models.LookupStadium", "Location")
                        .WithMany("FixtureDetails")
                        .HasForeignKey("LocationId")
                        .HasConstraintName("FK_FixtureDetails_LookupStadium")
                        .IsRequired();

                    b.HasOne("BettingApp.API.Models.LookupSport", "Sport")
                        .WithMany("FixtureDetails")
            ...
            modelBuilder.Entity("BettingApp.API.Models.LookupPlayer", b =>
                {
                    b.HasOne("BettingApp.API.Models.LookupTeam", "Team")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BettingApp.API.IdentityAuth.ApplicationUser", null)
                        .WithMany()
